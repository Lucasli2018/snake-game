...
共 18 个测试文件，按轮次组织：01 方向队列、02 食物、03 碰撞、04 暂停恢复、05 速度曲线、06 存储、
07 静态检查、08 集成压力、09 回归、10 排行榜、11 QA 复核、12 B 轮、13 C 轮、14 D 轮、15 E 轮
（生命值 / Combo 连击 / 过关三选一升级卡）、16 F 轮（Boss 血条 / 多形态 / 毒区地形）、17 G 轮
（模式切换 / 成就解锁 / 皮肤解锁 / 跨局统计）、18 排行榜独立按钮与面板、19 H 轮
（分享码 / 好友榜 / 成绩卡）。
...
| `12-b-round.test.js` | B 轮体验闭环：键盘方向键 keydown 转向 + 反向过滤、轻点暂停/继续/开始、浅深主题切换 + 持久化 + 不干扰游戏 |
